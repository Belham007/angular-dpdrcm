...
import { Component, Renderer2, NgZone, AfterViewInit, OnDestroy, ViewEncapsulation } from '@angular/core';
...
@Component({
    ...
    template: `
        ...
        >
            ...
            <kendo-grid-column field="Category.CategoryName" title="Category" [width]="300"> </kendo-grid-column>
            <kendo-grid-column field="UnitPrice" title="Price" [width]="120"> </kendo-grid-column>
            <kendo-grid-column field="UnitsInStock" title="In stock" [width]="120"> </kendo-grid-column>
